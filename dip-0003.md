...
Applicable to any type:
  ...
  5. networkInfo fails validation [(see rules)](dip-0003/network-info.md#netinfo_rules)
...
A ProUpServTx is invalid if any of these conditions are true:
  ...
  2. networkInfo fails validation [(see rules)](dip-0003/network-info.md#netinfo_rules)
...
See [network information appendix](dip-0003/network-info.md)
